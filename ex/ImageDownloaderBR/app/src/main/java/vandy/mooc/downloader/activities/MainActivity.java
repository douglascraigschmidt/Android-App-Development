...
public class MainActivity
   ...
   /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Call local helper method to register a broadcast receiver
        // that will receive and display a list of local image URLs.
        registerBroadcastReceiver();
    }

    /**
     * Creates a broadcast receiver instance that receives a data
     * intent from the DownloadImageActivity.  This intent contains
     * the Uri of a downloaded image to display.
     */
    private void registerBroadcastReceiver() {
        // Create a DownloadReceiver that's called by the Activity
        // Manager Service framework when a broadcast has been sent.
