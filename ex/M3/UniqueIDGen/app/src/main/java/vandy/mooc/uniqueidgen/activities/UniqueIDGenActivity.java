 ...
 * the UniqueIDGenService, which is a bound service.
 */
public class UniqueIDGenActivity
    ...
    /**
     * Receives the reply from the UniqueIDGenService containing the unique ID
    ...
    static class ReplyHandler 
        ...
        public ReplyHandler(UniqueIDGenActivity mainActivity) {
            this.mUniqueIDGenActivity = mainActivity;
